...
public interface ChatRoomRepository extends JpaRepository<ChatRoom, Long> {
    List<ChatRoom> findByPost(CompanionPost post);

    boolean existsByPostIdAndEndedAtIsNotNull(Long postId);

    Optional<ChatRoom> findFirstByPostIdAndEndedAtIsNotNullOrderByEndedAtDesc(Long postId);
